...
<div class="col-md-6 col-md-offset-3">
    <div class="box box-info">
        ...
        <form action="{{ route('product.update', $product) }}" class="form-horizontal" method="POST" enctype="multipart/form-data">
            @csrf
            @method("PUT")
            <div class="box-body">
                ...
                <div class="form-group {{ $errors->has('description') ? 'has-error' : '' }}">
                    ...
                    <div class="col-sm-10">
                    <textarea name="description" id="" cols="5" rows="10" class="form-control" placeholder="Product Description">{{ old('description') ?? $product->description}}</textarea>
                ...
                <div class="form-group {{ $errors->has('image') ? 'has-error' : '' }}">
                    ...
                    <div class="col-sm-10">
                        <input type="file" name="image" class="form-data" value="{{ old('image') ?? $product->image }}">
                            @if ($errors->has('image'))
                            <p class="help-block">
                                {{ $errors->first('image') }}
                            </p>
